...
focus: provides consistent behaviour, code should not break when we switch into different objects
...
create proper interfaces with specific tasks and distributes amongst the interfaces
